...
export default function Hero() {
  ...
  return (
    <section id="hero" className="min-h-screen flex items-center justify-center px-4 pt-28">
      <div className="w-full max-w-7xl mx-auto">
        <div className="p-6 sm:p-8 lg:p-12 rounded-3xl bg-white/5 backdrop-blur-md border border-white/10 shadow-2xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-white leading-tight text-center lg:text-left lg:col-span-2 lg:row-start-1">
              {t("iam")}{" "}
            ...
            <div className="flex justify-center lg:justify-end lg:col-start-3 lg:row-start-1 lg:row-span-4">
            ...
            <p className="text-gray-300 max-w-xl mx-auto lg:mx-0 leading-relaxed text-base sm:text-lg lg:col-span-2 lg:row-start-2">
              {t("description")}
            </p>

            <div className="flex justify-center lg:justify-start lg:col-span-2 lg:row-start-3">
              <a
                href={`/CV_Esteban_Abanto_${locale.toUpperCase()}.pdf`}
                download
